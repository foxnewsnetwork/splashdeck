...
(function() {
  var DeskModel, Flash, ModalView, PageModel, Session, StickiesCollection, StickyModel, StickyView, ToolbarView, desktop, methodMap,
  ...
  Session = (function(_super) {
    ...
    Session.login = function(email, password, callback) {
      var session;
      session = new Session({
        email: email,
        password: password
      ...
      return session.save(session, {
        success: function(model, response) {
          if (response['success'] != null) {
            ...
            if (callback != null) {
              return callback("You have failed");
            }
          }
        },
        error: function() {
          ...
          if (callback != null) {
            return callback("Wrong Email - Password Combination");
          }
        }
      });
    };
    ...
    Session.logout = function(callback) {
      ...
      Session.admin = null;
      return Backbone.sync("delete", Session.admin, {
        success: callback,
        url: "/users/sign_out"
      });
    };

    Session.prototype.name = "user";

    Session.prototype.url = "/users/sign_in";

    return Session;

  })(Backbone.Model);

  StickyModel = (function(_super) {

    __extends(StickyModel, _super);

    function StickyModel() {
      return StickyModel.__super__.constructor.apply(this, arguments);
    }

    StickyModel.debug_counter = 0;

    StickyModel.attr_accessible = ['x', 'y', 'width', 'height', 'category', 'content', 'metadata'];

    StickyModel.prototype.name = "sticky";

    StickyModel.prototype.user_id = void 0;

    StickyModel.prototype.page_id = void 0;

    StickyModel.prototype.defaults = {
      "x": void 0,
      "y": void 0,
      "width": 300,
      "height": 50,
    ...
    StickyModel.prototype.serialize = function() {
      var data, key, _i, _len, _ref;
      data = {};
      _ref = StickyModel.attr_accessible;
    ...
    StickyModel.prototype.initialize = function() {
      var position;
    ...
    StickyModel.prototype.setup_view = function() {
      var _this = this;
      this.view = new StickyView({
        model: this
      });
      this.view.update_callback = function(data) {
        if (_this.id != null) {
    ...
    StickyModel.prototype.activate = function() {
      return this.view.show();
    };

    StickyModel.prototype.deactivate = function() {
  ...
  StickyView = (function(_super) {

    __extends(StickyView, _super);
    ...
    StickyView.prototype.update_callback = function(data) {
    ...
    StickyView.prototype.hide = function() {
      return $(this.el).hide();
    };
  ...
  StickiesCollection = (function(_super) {

    __extends(StickiesCollection, _super);

    function StickiesCollection() {
      return StickiesCollection.__super__.constructor.apply(this, arguments);
    }

    StickiesCollection.prototype.model = StickyModel;

    StickiesCollection.prototype.activate = function() {
      var _this = this;
      return this.fetch({
        url: this.url + "?offset=0&limit=50",
        success: function(models, responses) {
          var k, model, _i, _ref;
          for (k = _i = 1, _ref = models.length; 1 <= _ref ? _i <= _ref : _i >= _ref; k = 1 <= _ref ? ++_i : --_i) {
            model = models.at(k - 1);
            model.id = model.get("id");
            model.page_id = model.get("page_id");
            model.user_id = model.get("user_id");
            model.url = _this.url + ("/" + model.id);
          }
          return Flash.show("Loaded " + responses.length + " stickies from the server into " + (JSON.stringify(_this)), "info");
        },
        error: function(response) {
          return Flash.show("Oh no, stickies collection fetch error " + (JSON.stringify(response)), "error");
        }
      });
    };

    StickiesCollection.prototype.deactivate = function() {
      return _.each(this.toArray(), function(sticky) {
        return sticky.deactivate();
      });
    };

    return StickiesCollection;
  ...
  PageModel = (function(_super) {
    ...
    PageModel.prototype.url = "/pages";

    PageModel.prototype.name = "page";

    PageModel.prototype.initialize = function() {
      return this.stickies = new StickiesCollection();
    };

    PageModel.prototype.new_sticky = function(data, callback) {
      var sticky,
        _this = this;
      sticky = new StickyModel(data);
      sticky.url = "/pages/" + this.id + "/stickies";
    ...
    PageModel.prototype.activate = function() {
      $("title").html(this.get("title"));
      this.stickies.activate();
      return Backbone.Events.trigger("page:activate", this.id);
    };

    PageModel.prototype.deactivate = function() {
      this.stickies.deactivate();
      return Backbone.Events.trigger("page:deactivate", this.id);
    };
  ...
  ModalView = (function(_super) {
    ...
    ModalView.input_sanitizor = function(string) {
      var str;
      str = escape(string);
    ...
    ModalView.generate_form = function(category) {
      var input, label, output, textarea, thing, things, _i, _j, _k, _len, _len1, _len2;
    ...
    ModalView.form = {
      "comment": {
        "modal_title": "Leave Comment",
        "modal_body": ModalView.generate_form("comment"),
        "modal_action": "Comment"
      },
      "login": {
        "modal_title": "Owner Login",
        "modal_body": ModalView.generate_form("login"),
        "modal_action": "Login"
      },
      "text": {
        "modal_title": "Text Sticky",
        "modal_body": ModalView.generate_form("text"),
        "modal_action": "Write"
      },
      "image": {
        "modal_title": "Image Sticky",
        "modal_body": ModalView.generate_form("image"),
        "modal_action": "Link"
      },
      "code": {
        "modal_title": "Code Block",
        "modal_body": ModalView.generate_form("code"),
        "modal_action": "Post"
      },
      "page": {
        "modal_title": "New Page",
        "modal_body": ModalView.generate_form("page"),
        "modal_action": "Create"
      }
    };
    ...
    ModalView.prototype.template = _.template("		<div class='modal-header'>			<button type='button' class='close' data-dismiss='modal' aria-hidden='true'>&times;</button>			<h3 id='myModalLabel'><%= modal_title %></h3>		</div>		<div class='modal-body'>			<%= modal_body %>		</div>		<div class='modal-footer'>			<button class='btn' data-dismiss='modal' aria-hidden='true'>Close</button>			<button class='btn btn-primary modal-action'><%= modal_action %></button>		</div>	");

    ModalView.prototype.modal_action = function() {
      var input, name, set, _i, _len, _ref;
      input = {};
      _ref = ModalView.modal_contents[this.category];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        set = _ref[_i];
        name = set['name'];
      ...
      return Backbone.Events.trigger("modal:action", input);
    };

    ModalView.prototype.render = function(category) {
      var attr, key, val, _i, _len, _ref;
      switch (category) {
        case "pages":
          $(this.el).html("					<div class='modal-header'>						<button type='button' class='close' data-dismiss='modal' aria-hidden='true'>&times;</button>						<h3 id='myModalLabel'>Pages Index</h3>					</div>					<div class='modal-body'>						<ul class='page-index'></ul>					</div>");
          break;
        default:
          $(this.el).html(this.template(ModalView.form[category]));
      }
      ...
      _ref = [
        {
          ...
          "aria-labelledby": "my" + category + "label"
        }, {
          "aria-hidden": true
        }
      ];
    ...
    ModalView.prototype.generate_pages_index = function(response) {
      var page, template, _i, _len, _results;
      template = _.template("<li>				<h4><a href='#<%= id %>' data-dismiss='modal' aria-hidden='true' class='close' content='<%= id %>'><%= title %></a></h4>				<small><%= created_at %></small>		</li>");
      this.$(".page-index").html("");
      _results = [];
      for (_i = 0, _len = response.length; _i < _len; _i++) {
        page = response[_i];
        this.$(".page-index").append(template(page));
        _results.push(this.$("a[href='#" + page['id'] + "']").click((function(id) {
          return function() {
            return Backbone.Events.trigger("modal:switch_page", id);
          };
        })(page['id'])));
      }
      return _results;
  ...
  ToolbarView = (function(_super) {
    ...
    function ToolbarView() {
      this.unadminify = __bind(this.unadminify, this);

      this.adminify = __bind(this.adminify, this);
      return ToolbarView.__super__.constructor.apply(this, arguments);
    }

    ToolbarView.prototype.tagName = "ul";

    ToolbarView.prototype.className = "desktop-toolbar ui-widget-content";

    ToolbarView.prototype.mode = "normal";

    ToolbarView.prototype.buttons = [
      {
        "id": "pages",
        "thing": "Pages",
    ...
    ToolbarView.prototype.template = _.template("		<li target='<%= id %>'><a href='#<%= id %>' id='btn-<%= id %>' class='btn btn-mini btn-<%= color %>' rel='tooltip' title='<%= thing %>' data-toggle='modal'>			<i class='icon-<%= icon %>'></i>		</li></a>	");
    ...
    ToolbarView.prototype.render = function() {
      var button, m_id, modal, _i, _len, _ref,
        _this = this;
      if (this.ready != null) {
        return;
      }
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        button = _ref[_i];
        $(this.el).append(this.template(button));
        switch (button["id"]) {
          case "comment":
          case "login":
          case "code":
          ...
          case "page":
            ...
            break;
          case "pages":
            this.pages_modal = new ModalView();
            m_id = this.pages_modal.render("pages");
      ...
      this.ready = true;
      this.unadminify();
      Backbone.Events.on("session:login", this.adminify);
      return Backbone.Events.on("desk:pages_fetch", function(response) {
        return _this.pages_modal.generate_pages_index(response);
      });
    };

    ToolbarView.prototype.adminify = function() {
      var target, _i, _len, _ref, _results;
      this.mode = "admin";
      _ref = ['text', 'image', 'code', 'page'];
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        target = _ref[_i];
        _results.push(this.$("li[target='" + target + "']").show());
      }
      return _results;
    };

    ToolbarView.prototype.unadminify = function() {
      var target, _i, _len, _ref, _results;
      this.mode = "normal";
      _ref = ['text', 'image', 'code', 'page'];
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        target = _ref[_i];
        _results.push(this.$("li[target='" + target + "']").hide());
      }
      return _results;
    };
    ...
    */
    ...
    ToolbarView.prototype.pages_modal = function() {
      return Backbone.Events.trigger("toolbar:pages");
    };

    ToolbarView.prototype.page_modal = function() {
      if (this.mode === "admin") {
        return this.open_modal("page");
      } else {
        return Flash.show("You need to be the owner of this blog in order to add new pages", "warning");
      }
    };

    ToolbarView.prototype.login_modal = function() {
      if (this.mode === "normal") {
        return this.open_modal("login");
      } else {
        return Flash.show("You are already logged in!", "warning");
      }
    };

    ToolbarView.prototype.comment_modal = function() {
      return this.open_modal("comment");
    };

    ToolbarView.prototype.image_modal = function() {
      return this.open_modal("image");
    };

    ToolbarView.prototype.text_modal = function() {
      return this.open_modal("text");
    };

    ToolbarView.prototype.code_modal = function() {
      return this.open_modal("code");
    };

    ToolbarView.prototype.open_modal = function(category) {
      return $("" + category + "-modal").modal();
    };
  ...
  DeskModel = (function(_super) {

    __extends(DeskModel, _super);

    function DeskModel() {
      return DeskModel.__super__.constructor.apply(this, arguments);
    }

    DeskModel.action_processor = {
    ...
    DeskModel.prototype.initialize = function() {
      var _this = this;
      this.toolbar = new ToolbarView();
      this.active_page = new PageModel();
      this.pages = [];
      this.pages_hash = {};
      this.toolbar.render();
      this.establish_connection();
      Backbone.Events.on("modal:action", function(input) {
        var data;
        data = DeskModel.action_processor[input['category']](input);
        switch (input['category']) {
          case 'page':
            return _this.new_page(data);
          case 'login':
            return Session.login(input['email'], input['password']);
          default:
            return _this.active_page.new_sticky(data);
        }
      });
      Backbone.Events.on("toolbar:pages", function() {
        return _this.fetch({
          url: "/pages?offset=0&limit=50",
          success: function(model, response) {
            if (response != null) {
              return Backbone.Events.trigger("desk:pages_fetch", response);
            } else {
              return Flash.show("Oh no, we ran into a problem trying to load pages index", "error");
            }
          },
          error: function(response) {
            return Flash.show("Oh no, we ran into a problem trying to load pages index " + (JSON.stringify(response)), "error");
          }
        });
      });
      return Backbone.Events.on("modal:switch_page", function(id) {
        return _this.switch_to(id);
      });
    };

    DeskModel.prototype.establish_connection = function(callback) {
      var _this = this;
      return this.active_page.fetch({
        url: "/",
        success: function(model, response) {
          if ((response != null) && (response['id'] != null)) {
            _this.active_page.set('title', response['title']);
            _this.active_page.id = response['id'];
            _this.active_page.user_id = response['user_id'];
            _this.active_page.url = "/pages/" + response['id'];
            _this.active_page.stickies.url = model.url + "/stickies";
            _this.pages_hash[response['id']] = _this.pages.length;
            _this.pages.push(_this.active_page);
            _this.switch_to(response['id']);
          } else {
    ...
    DeskModel.prototype.switch_to = function(id) {
      var page,
        _this = this;
      if (this.pages_hash[id] != null) {
        return this.goto_page(this.pages_hash[id]);
      } else {
        page = new PageModel();
        page.id = id;
        page.url = "/pages/" + id;
        ...
        return page.fetch({
          success: function(model, response) {
            ...
            _this.pages_hash[id] = _this.pages.length;
            _this.pages.push(page);
            return _this.switch_to(id);
          },
          error: function(response) {
            return Flash.show("The ID " + id + " you requested isn't cached on your local machine and isn't in the db.", "error");
          }
        });
      }
    };

    DeskModel.prototype.goto_page = function(number) {
      if (!(number != null) || number < this.pages.length) {
        this.active_page.deactivate();
        if (number != null) {
          this.active_page = this.pages[number];
        }
        if (number == null) {
          this.active_page = this.pages[this.pages.length - 1];
        }
        this.active_page.activate();
        return Flash.show("We have switched to page " + (this.active_page.get('title')), "info");
      } else {
        return Flash.show("404: the page you requested " + number + " doesn't exist", "warning");
      }
    };

    DeskModel.prototype.new_page = function(data, callback) {
      var desk, page;
      page = new PageModel();
      page.set(data, {
        "silent": true
  ...
  if (typeof desktop === "undefined" || desktop === null) {
    desktop = null;
  }
